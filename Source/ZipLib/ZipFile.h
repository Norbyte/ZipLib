...
class ZipFile
{
  ...
  public:
     ...
     */
    static void Save(ZipArchive::Ptr zipArchive, const std::wstring& zipPath);
     ...
     * \param zipPath     Full pathname of the zip archive file.
     */
    static void SaveAndClose(ZipArchive::Ptr zipArchive, const std::wstring& zipPath);
     ...
     */
    static bool IsInArchive(const std::wstring& zipPath, const std::string& fileName);
     ...
     */
    static void AddFile(const std::wstring& zipPath, const std::string& fileName, ICompressionMethod::Ptr method = DeflateMethod::Create());
     ...
     * \param level         (Optional) The level of compression. Use CompressionLevel::Stored for no compression.
     */
    static void AddFile(const std::wstring& zipPath, const std::string& fileName, const std::string& inArchiveName, ICompressionMethod::Ptr method = DeflateMethod::Create());
     ...
     * \param level     (Optional) The level of compression. Use CompressionLevel::Stored for no compression.
     */
    static void AddEncryptedFile(const std::wstring& zipPath, const std::string& fileName, const std::string& password, ICompressionMethod::Ptr method = DeflateMethod::Create());
     ...
     * \param level         (Optional) The level of compression. Use CompressionLevel::Stored for no compression.
     */
    static void AddEncryptedFile(const std::wstring& zipPath, const std::string& fileName, const std::string& inArchiveName, const std::string& password, ICompressionMethod::Ptr method = DeflateMethod::Create());
     ...
     */
    static void ExtractFile(const std::wstring& zipPath, const std::string& fileName);
     ...
     */
    static void ExtractFile(const std::wstring& zipPath, const std::string& fileName, const std::string& destinationPath);
     ...
     * \param password  The password.
     */
    static void ExtractEncryptedFile(const std::wstring& zipPath, const std::string& fileName, const std::string& password);
     ...
     * \param password        The password.
     */
    static void ExtractEncryptedFile(const std::wstring& zipPath, const std::string& fileName, const std::string& destinationPath, const std::string& password);
     ...
     */
    static void RemoveEntry(const std::wstring& zipPath, const std::string& fileName);
};
